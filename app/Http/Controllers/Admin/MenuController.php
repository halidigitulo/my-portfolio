        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('aksi', function ($menu) {
                    ...
                    $editButton = '<button type="button" class="btn btn-sm btn-icon btn-outline-warning edit-menu" data-id="' . $menu->id . '" name="edit"><span class="tf-icons bx bxs-edit"></span></button>';
                    $spasi = ' ';
                    if ($menu->is_protected) {
                        return $editButton;
                    }
                    $deleteButton = '<button type="button" class="btn btn-sm btn-outline-danger btn-icon hapus-menu" data-id="' . $menu->id . '" name="edit"><span class="tf-icons bx bx-trash"></span></button>';
