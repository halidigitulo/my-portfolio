        ...
        if (request()->ajax()) {
            ...
            return datatables()->of($permissions)
                ->addColumn('aksi', function ($permission) {
                    ...
                    $button = '<button class="btn btn-icon btn-outline-danger btn-sm hapus-permission" data-id="' . $permission->id . '" name="edit"><span class="tf-icons bx bx-trash"></span></button>';
                    return $button;
                })
                ->rawColumns(['aksi'])
                ->make(true);
