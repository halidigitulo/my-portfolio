...
INSERT INTO `menus` (`id`, `name`, `url`, `icon`, `parent_id`, `permission_name`, `is_protected`, `menu_group`, `sort_order`, `created_at`, `updated_at`) VALUES ('1', 'Dashboard', 'admin/dashboard', 'home-circle', NULL, 'dashboard.read', '1', NULL, '1', '2025-08-15 12:57:45', '2025-10-27 02:12:23');
INSERT INTO `menus` (`id`, `name`, `url`, `icon`, `parent_id`, `permission_name`, `is_protected`, `menu_group`, `sort_order`, `created_at`, `updated_at`) VALUES ('2', 'Settings', 'admin/settings', 'cog', NULL, NULL, '1', NULL, '2', '2025-08-15 12:57:45', '2025-10-27 02:12:23');
INSERT INTO `menus` (`id`, `name`, `url`, `icon`, `parent_id`, `permission_name`, `is_protected`, `menu_group`, `sort_order`, `created_at`, `updated_at`) VALUES ('3', 'Users', 'admin/users', 'user', '2', 'users.read', '1', NULL, '1', '2025-08-15 12:57:45', '2025-10-27 02:12:23');
INSERT INTO `menus` (`id`, `name`, `url`, `icon`, `parent_id`, `permission_name`, `is_protected`, `menu_group`, `sort_order`, `created_at`, `updated_at`) VALUES ('4', 'Roles', 'admin/roles', 'color', '2', 'roles.read', '1', NULL, '2', '2025-08-15 12:57:45', '2025-10-27 02:12:23');
INSERT INTO `menus` (`id`, `name`, `url`, `icon`, `parent_id`, `permission_name`, `is_protected`, `menu_group`, `sort_order`, `created_at`, `updated_at`) VALUES ('5', 'Menus', 'admin/menus', 'menu', '2', 'menus.read', '1', NULL, '3', '2025-08-15 12:57:45', '2025-10-27 02:12:23');
INSERT INTO `menus` (`id`, `name`, `url`, `icon`, `parent_id`, `permission_name`, `is_protected`, `menu_group`, `sort_order`, `created_at`, `updated_at`) VALUES ('6', 'Permissions', 'admin/permissions', 'mouse-alt', '2', 'permissions.read', '1', NULL, '4', '2025-08-15 12:57:45', '2025-10-27 02:12:23');
INSERT INTO `menus` (`id`, `name`, `url`, `icon`, `parent_id`, `permission_name`, `is_protected`, `menu_group`, `sort_order`, `created_at`, `updated_at`) VALUES ('7', 'Profile', 'admin/profile', 'building', NULL, 'profile.read', '1', NULL, '3', '2025-08-15 12:57:45', '2025-10-27 02:12:23');
INSERT INTO `menus` (`id`, `name`, `url`, `icon`, `parent_id`, `permission_name`, `is_protected`, `menu_group`, `sort_order`, `created_at`, `updated_at`) VALUES ('8', 'Master', '#', 'blocks', NULL, NULL, '0', NULL, '4', '2025-10-16 22:50:23', '2025-10-27 02:12:23');
INSERT INTO `menus` (`id`, `name`, `url`, `icon`, `parent_id`, `permission_name`, `is_protected`, `menu_group`, `sort_order`, `created_at`, `updated_at`) VALUES ('9', 'General', 'admin/general', 'circle-line', '8', 'general.read', '0', NULL, '1', '2025-10-16 22:57:50', '2025-10-27 02:12:23');
INSERT INTO `menus` (`id`, `name`, `url`, `icon`, `parent_id`, `permission_name`, `is_protected`, `menu_group`, `sort_order`, `created_at`, `updated_at`) VALUES ('10', 'Client', 'admin/client', 'people-handshake', NULL, 'clients.read', '0', NULL, '5', '2025-10-16 23:01:35', '2025-10-27 02:12:23');
INSERT INTO `menus` (`id`, `name`, `url`, `icon`, `parent_id`, `permission_name`, `is_protected`, `menu_group`, `sort_order`, `created_at`, `updated_at`) VALUES ('11', 'Services', 'admin/service', 'circle-line', '8', 'services.read', '0', NULL, '2', '2025-10-16 23:03:02', '2025-10-27 02:12:23');
INSERT INTO `menus` (`id`, `name`, `url`, `icon`, `parent_id`, `permission_name`, `is_protected`, `menu_group`, `sort_order`, `created_at`, `updated_at`) VALUES ('12', 'Project', 'admin/project', 'git-pull-request-closed', NULL, 'projects.read', '0', NULL, '6', '2025-10-16 23:04:07', '2025-10-27 02:12:23');
INSERT INTO `menus` (`id`, `name`, `url`, `icon`, `parent_id`, `permission_name`, `is_protected`, `menu_group`, `sort_order`, `created_at`, `updated_at`) VALUES ('13', 'Post', 'admin/post', 'book-open', NULL, 'posts.read', '0', NULL, '8', '2025-10-16 23:04:52', '2025-10-27 02:12:23');
INSERT INTO `menus` (`id`, `name`, `url`, `icon`, `parent_id`, `permission_name`, `is_protected`, `menu_group`, `sort_order`, `created_at`, `updated_at`) VALUES ('14', 'FAQ', 'admin/faq', 'message-question-mark', NULL, 'faqs.read', '0', NULL, '9', '2025-10-16 23:05:37', '2025-10-27 02:12:23');
INSERT INTO `menus` (`id`, `name`, `url`, `icon`, `parent_id`, `permission_name`, `is_protected`, `menu_group`, `sort_order`, `created_at`, `updated_at`) VALUES ('15', 'Testimonial', 'admin/testimoni', 'message-bubble-dots-2', NULL, 'testimonials.read', '0', NULL, '10', '2025-10-16 23:06:43', '2025-10-27 02:12:23');
INSERT INTO `menus` (`id`, `name`, `url`, `icon`, `parent_id`, `permission_name`, `is_protected`, `menu_group`, `sort_order`, `created_at`, `updated_at`) VALUES ('16', 'Invoice', 'admin/invoice', 'wallet', NULL, 'invoices.read', '0', NULL, '11', '2025-10-16 23:08:11', '2025-10-27 02:12:23');
INSERT INTO `menus` (`id`, `name`, `url`, `icon`, `parent_id`, `permission_name`, `is_protected`, `menu_group`, `sort_order`, `created_at`, `updated_at`) VALUES ('17', 'Resume', 'admin/resume', 'circle-line', '8', 'resume.read', '0', NULL, '3', '2025-10-16 23:08:41', '2025-10-27 02:12:23');
INSERT INTO `menus` (`id`, `name`, `url`, `icon`, `parent_id`, `permission_name`, `is_protected`, `menu_group`, `sort_order`, `created_at`, `updated_at`) VALUES ('18', 'Stack', 'admin/stack', 'circle-line', '8', 'stack.read', '0', NULL, '4', '2025-10-21 12:56:31', '2025-10-27 02:12:23');
INSERT INTO `menus` (`id`, `name`, `url`, `icon`, `parent_id`, `permission_name`, `is_protected`, `menu_group`, `sort_order`, `created_at`, `updated_at`) VALUES ('19', 'Product', 'admin/product', 'box', NULL, 'product.read', '0', NULL, '7', '2025-10-23 01:53:23', '2025-10-27 02:12:23');
INSERT INTO `menus` (`id`, `name`, `url`, `icon`, `parent_id`, `permission_name`, `is_protected`, `menu_group`, `sort_order`, `created_at`, `updated_at`) VALUES ('20', 'Backup & Restore', 'admin/backup-restore', 'circle-line', '2', 'backup-restore.read', '0', NULL, '5', '2025-10-24 12:48:26', '2025-10-27 02:12:23');
...
INSERT INTO `profiles` (`id`, `nama`, `tagline`, `direktur`, `alamat`, `kota`, `maps`, `telp`, `hp`, `email`, `website`, `video_url`, `instagram`, `facebook`, `youtube`, `tiktok`, `isi`, `logo`, `cover`, `hero`, `pdf`, `created_at`, `updated_at`) VALUES ('1', 'Bucu Media', 'Let The Expert\'s Work', 'Haldi', 'Jl. Ahmad Yani No. 9 Selasalas, Sandubaya, Mataram', 'Mataram', NULL, '087863657121', NULL, 'info@bucumedia.id', 'bucumedia.id', NULL, NULL, NULL, NULL, NULL, '<p>ini adalah profile</p>', 'Bucu Media_logo.png', 'default-cover.jpg', 'Bucu Media_hero.png', NULL, '2025-08-15 12:57:45', '2025-10-27 02:13:30');
...
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES ('p4mpIUKjOBnIm7Az9V4t5hjUflw9EpeFwGOLDbAo', '1', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36', '', '1761531314');
