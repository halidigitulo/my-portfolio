                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <div class="testimonial-item">
                      ...
                      <div class="testimonial-profile">
                        <img src="{{asset('front')}}/img/person/person-f-1.webp" alt="Reviewer" class="img-fluid rounded-circle">
                        <div>
                          <h3>Jane Smith</h3>
                  ...
                  <div class="swiper-slide">
                    <div class="testimonial-item">
                      ...
                      <div class="testimonial-profile">
                        <img src="{{asset('front')}}/img/person/person-m-2.webp" alt="Reviewer" class="img-fluid rounded-circle">
                        <div>
                  ...
                  <div class="swiper-slide">
                    <div class="testimonial-item">
                      ...
                      <div class="testimonial-profile">
                        <img src="{{asset('front')}}/img/person/person-f-3.webp" alt="Reviewer" class="img-fluid rounded-circle">
                        <div>
                          <h3>Emily Davis</h3>
                  ...
                  <div class="swiper-slide">
                    <div class="testimonial-item">
                      ...
                      <div class="testimonial-profile">
                        <img src="{{asset('front')}}/img/person/person-m-4.webp" alt="Reviewer" class="img-fluid rounded-circle">
                        <div>
                          <h3>Robert Wilson</h3>
