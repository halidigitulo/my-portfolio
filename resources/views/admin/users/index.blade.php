    ...
    <script>
        ...
        $(document).ready(function() {
                    ...
                    success: function(data) {
                        ...
                        if (data.profile_picture) {
                            $('#preview-foto').attr('src',
                                `/uploads/users/${data.profile_picture}`).show();
                        } else {
                            $('#preview-foto').hide();
                        }
            ...
            $('#userForm').submit(function(e) {
                ...
                let id = $('#user_id').val();
                let url = id ? `/admin/users/${id}` :
                    '/admin/users'; // Update if ID exists, otherwise create
                let method = id ? 'POST' :
            ...
            $(document).on('change', '.check-user', function() {
                ...
                $.ajax({
                    url: `/admin/users/${id}`, // Define your route for updating status
                    type: 'PUT',
                    data: {
                        id: id,
                        is_active: is_active,
